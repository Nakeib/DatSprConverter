...
namespace OpenTibiaUnity.Core.Assets
{
    ...
    public sealed class ThingType
    {
        ...
        public bool CompareWith(ThingType secondThing, ContentSprites firstSprites, ContentSprites secondSprites, bool ignoreAttributes = true)
        {
            if (ignoreAttributes ||
                (HasAttribute(AttributesUniform.Ground) == secondThing.HasAttribute(AttributesUniform.Ground) &&
                 //HasAttribute(AttributesUniform.GroundBorder) == secondThing.HasAttribute(AttributesUniform.GroundBorder) &&
                 HasAttribute(AttributesUniform.Bottom) == secondThing.HasAttribute(AttributesUniform.Bottom) &&
                 HasAttribute(AttributesUniform.Top) == secondThing.HasAttribute(AttributesUniform.Top) &&
                 HasAttribute(AttributesUniform.Container) == secondThing.HasAttribute(AttributesUniform.Container) &&
                 HasAttribute(AttributesUniform.Stackable) == secondThing.HasAttribute(AttributesUniform.Stackable) &&
                 //HasAttribute(AttributesUniform.ForceUse) == secondThing.HasAttribute(AttributesUniform.ForceUse) &&
                 //HasAttribute(AttributesUniform.MultiUse) == secondThing.HasAttribute(AttributesUniform.MultiUse) &&
                 HasAttribute(AttributesUniform.Writable) == secondThing.HasAttribute(AttributesUniform.Writable) &&
                 HasAttribute(AttributesUniform.WritableOnce) == secondThing.HasAttribute(AttributesUniform.WritableOnce) &&
                 HasAttribute(AttributesUniform.FluidContainer) == secondThing.HasAttribute(AttributesUniform.FluidContainer) &&
                 HasAttribute(AttributesUniform.Splash) == secondThing.HasAttribute(AttributesUniform.Splash) &&
                 HasAttribute(AttributesUniform.Unpassable) == secondThing.HasAttribute(AttributesUniform.Unpassable) &&
                 HasAttribute(AttributesUniform.Unmoveable) == secondThing.HasAttribute(AttributesUniform.Unmoveable) &&
                 //HasAttribute(AttributesUniform.Unsight) == secondThing.HasAttribute(AttributesUniform.Unsight) &&
                 HasAttribute(AttributesUniform.BlockPath) == secondThing.HasAttribute(AttributesUniform.BlockPath) &&
                 HasAttribute(AttributesUniform.Pickupable) == secondThing.HasAttribute(AttributesUniform.Pickupable) &&
                 HasAttribute(AttributesUniform.Hangable) == secondThing.HasAttribute(AttributesUniform.Hangable) &&
                 //HasAttribute(AttributesUniform.HookSouth) == secondThing.HasAttribute(AttributesUniform.HookSouth) &&
                 //HasAttribute(AttributesUniform.HookEast) == secondThing.HasAttribute(AttributesUniform.HookEast) &&
                 //HasAttribute(AttributesUniform.Rotateable) == secondThing.HasAttribute(AttributesUniform.Rotateable) &&
                 HasAttribute(AttributesUniform.Light) == secondThing.HasAttribute(AttributesUniform.Light) //&&
                 //HasAttribute(AttributesUniform.DontHide) == secondThing.HasAttribute(AttributesUniform.DontHide) &&
                 //HasAttribute(AttributesUniform.Translucent) == secondThing.HasAttribute(AttributesUniform.Translucent) &&
                 //HasAttribute(AttributesUniform.Offset) == secondThing.HasAttribute(AttributesUniform.Offset) &&
                 //HasAttribute(AttributesUniform.Elevation) == secondThing.HasAttribute(AttributesUniform.Elevation) &&
                 //HasAttribute(AttributesUniform.LyingCorpse) == secondThing.HasAttribute(AttributesUniform.LyingCorpse) &&
                 //HasAttribute(AttributesUniform.AnimateAlways) == secondThing.HasAttribute(AttributesUniform.AnimateAlways) &&
                 //HasAttribute(AttributesUniform.MinimapColor) == secondThing.HasAttribute(AttributesUniform.MinimapColor) &&
                 //HasAttribute(AttributesUniform.LensHelp) == secondThing.HasAttribute(AttributesUniform.LensHelp) &&
                 //HasAttribute(AttributesUniform.FullGround) == secondThing.HasAttribute(AttributesUniform.FullGround) &&
                 //HasAttribute(AttributesUniform.Look) == secondThing.HasAttribute(AttributesUniform.Look) &&
                 //HasAttribute(AttributesUniform.Cloth) == secondThing.HasAttribute(AttributesUniform.Cloth) &&
                 //HasAttribute(AttributesUniform.Market) == secondThing.HasAttribute(AttributesUniform.Market) &&
                 //HasAttribute(AttributesUniform.DefaultAction) == secondThing.HasAttribute(AttributesUniform.DefaultAction) &&
                 //HasAttribute(AttributesUniform.Use) == secondThing.HasAttribute(AttributesUniform.Use) &&
                 //HasAttribute(AttributesUniform.Wrapable) == secondThing.HasAttribute(AttributesUniform.Wrapable) &&
                 //HasAttribute(AttributesUniform.Unwrapable) == secondThing.HasAttribute(AttributesUniform.Unwrapable) &&
                 //HasAttribute(AttributesUniform.TopEffect) == secondThing.HasAttribute(AttributesUniform.TopEffect)
                 ))
            {
                foreach (var fgPair in FrameGroups)
                {
                    if (!secondThing.FrameGroups.ContainsKey(fgPair.Key))
                        return false;

                    FrameGroup firstFg = fgPair.Value;
                    FrameGroup secondFg = secondThing.FrameGroups[fgPair.Key];
                    if (firstFg.Sprites.Count != secondFg.Sprites.Count)
                        return false;

                    uint[] firstIds = firstFg.Sprites.ToArray();
                    uint[] secondIds = secondFg.Sprites.ToArray();
                    for (int index = 0; index < firstFg.Sprites.Count; index++)
                    {
                        uint firstId = firstIds[index];
                        uint secondId = secondIds[index];
                        if (firstSprites.spritesMap.ContainsKey(firstId) && secondSprites.spritesMap.ContainsKey(secondId))
                        {
                            string firstHashMD5 = firstSprites.spritesMap[firstId];
                            string secondHashMD5 = secondSprites.spritesMap[secondId];
                            if (!string.Equals(firstHashMD5, secondHashMD5))
                                return false;
                        }
                        else
                            return false;
